...
return [
    ...
    */
    ...
    |
    | 480 minutes (8 hours) rather than Laravel's stock 120. This is an
    | in-store point-of-sale: a counter screen is signed in for a whole shift
    | and is idle for long stretches between rushes. At 120 the session — and
    | with it the CSRF token — died mid-shift, and the next thing staff touched
