...
<body>
    <div class="app-wrapper">
        ...
        <div class="receipt-body">
            ...
            <div class="receipt-card">
                ...
                <div style="padding:0.3rem 0;">
                    ...
                    <div style="font-size:0.65rem;color:#888;padding-left:1.5rem;">{{ $item->options->pluck('name')->implode(', ') }}</div>
                    @endif
                </div>
                @endforeach
        ...
        @else
        <a href="{{ route('admin.completed-orders') }}" class="btn-back">
