                ...
                <div class="settings-card">
                    ...
                    <div class="discount-section">
                        ...
                        <label for="pwdImage" class="upload-box">
                            ...
                            <img src="{{ \App\Support\Img::url(auth()->user()->pwd_image) }}" style="width:100%;height:100%;object-fit:cover;border-radius:8px;">
                            @else
                    ...
                    <div class="discount-section">
                        ...
                        <label for="seniorImage" class="upload-box">
                            ...
                            <img src="{{ \App\Support\Img::url(auth()->user()->senior_image) }}" style="width:100%;height:100%;object-fit:cover;border-radius:8px;">
                            @else
                            <i class="bi bi-cloud-arrow-up"></i>
                            <span>upload</span>
                            @endif
