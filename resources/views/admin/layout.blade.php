    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Responsive tables */
            .content-card [style*="overflow-x: auto"],
            .content-card div[style*="overflow"] {
    ...
    {{-- Hamburger Button --}}
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin.users') }}" class="nav-link-item {{ request()->routeIs('admin.users') ? 'active' : '' }}">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;background:white;padding:0.6rem 1rem;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                @php
                    ...
                    if ($selectedBranchId !== 'all') {
                        $viewingLabel = $allBranches->find($selectedBranchId)?->name
                            ?? \App\Models\Branch::where('id', $selectedBranchId)->value('name')
                            ?? 'All Branches';
                    }
                @endphp
                <span style="font-size:0.78rem;font-weight:600;color:#555;">
                    <i class="bi bi-building"></i> Viewing:
                    <span style="color:#F4845F;">{{ $viewingLabel }}</span>
                </span>
